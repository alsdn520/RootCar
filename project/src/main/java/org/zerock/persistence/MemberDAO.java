...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	MemberVO idcheck(String id);//아이디중복 검사

	void insertMember(MemberVO mb);//회원가입

	MemberVO selectMember_id(String mem_id);//로그인 인증하기위해서 selectone 으로 회원 아이디만 가져온다
	
	void edit_update(String mem_id);  //회원 로그인시 방문수 증가 트랜젝션 적용 1트랜젝션 적용 1트랜젝션 적용 1
...
//↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	...
	MemberVO mypage_selectMember_id(String mem_id);//마이페이지 수정을 위해 로그인시 session 값으로 mem_id 를 가져온다 
	
	void My_page_edit_update(MemberVO mb);  //마이페이지 내정보 수정

	void member_edit_count(MemberVO mb);  //마이페이지 수정되면 트렌젝션 적용되서 mem_edit 컬럼 카운트 1증가
