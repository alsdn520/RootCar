                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="indexx">
                            <img src="./resources/img/logo-blue (2).png" alt="사진없음">
                        </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active"><a href="admin_main">관리자 메인</a>
                            </li>
                            <li><a href="member_admin_list">회원목록</a>
                            </li>
                            <li><a href="admin_pr">차량등록</a>  
                            </li>
                            <li><a href="admin_cartravel_list">예약관리</a>
                            </li>
                            <li><a href="admin_custom">게시판 관리</a>
                            </li>
                            <li><a href="admin_gongji_list">공지관리</a>
                            </li>
                            <li><a href="admin_logout">로그아웃</a>
                            </li>
