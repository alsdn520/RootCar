           ...
           <!-- Fixed navbar -->
            <div class="navbar navbar-static-top" id="nav" role="navigation">
                    ...
                    <div class="navbar-header ">
                        ...
                        <a class="navbar-brand" href="indexx" style="margin-right: 100%;">
                            <img src="./resources/img/logo-blue (2).png" alt="없음">
                        </a>
                    </div>
					<div style="float: left;">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-left">
                            <li class="active"><a href="indexx">홈</a>
                            </li>
                            <li><a href="welcome_company">회사소개</a>
                            </li>
                            <li><a href="team">팀 소개</a>  <!-- 팀원 소개 슬라이드 셉션으로 이동 -->
                            </li>
      
                            <li>
                            <c:if test="${empty mem_id}">
                            <a href="car_magazine_travel">렌트/여행/메거진</a>
                            </c:if>
                            <c:if test="${!empty mem_id}">
							<li>
							<a href="car_magazine_travel">렌트/여행/메거진 </a> 
