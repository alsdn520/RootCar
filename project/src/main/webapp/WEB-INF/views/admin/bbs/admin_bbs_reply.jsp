...
<div id="aMain_cont">
		...
		<h3>관리자 답변하기</h3>
		<form method="post" action="admin_bbs_reply_ok" onsubmit="return bbs_check();">
			<%-- 답변글 히든값 --%>
			...
			<div class="form-group has-feedback left">
				<input type="text" name="bbs_name" id="bbs_name" size="14" tabindex="1" class="form-control" placeholder="이름" value="${admin_name}"/> 
			...
			<input class="btn btn-default btn-lg right" type="button" value="취소"  onclick="location='admin_custom';" /> 
