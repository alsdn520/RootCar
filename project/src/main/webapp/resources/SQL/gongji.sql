...
create table gongji (
	...
	,gongji_name varchar2(100) not null --작성자
	,gongji_title varchar2(200) not null --제목
	,gongji_pwd varchar2(20) not null --공지비번
	,gongji_cont varchar2(4000) not null --내용
...
values (g_no_seq.nextval,'관리자','공지제목','aa','공지내용',sysdate);

select * from gongji order by gongji_no desc; --내림차순 정렬